...
> 本文档集遵循 **MumuSpec** 规范框架编写，是 MumuSpec 方法论的实践示例。
> MumuSpec 是一套面向软件规格文档的写作方法论，`spec/template/` 为空白模板，`spec/618-promotion/` 为填充示例。
...
> 全部文档 **MUST** 使用以下统一编号格式，禁止各文档自创格式。
